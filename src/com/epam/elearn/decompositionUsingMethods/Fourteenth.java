...
//        decomposeNumbersOnDigits(k);
//    }
//
//
//    public static void decomposeNumbersOnDigits(int k) {
//        int mass[] = new int[k];
...
//    }
    public static void main(String[] args) {
        ...
        decomposeNumbersOnDigits(mass);
    }


    public static int[] decomposeNumbersOnDigits(int[] mass) {
