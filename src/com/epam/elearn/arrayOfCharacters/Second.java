...
//        System.out.println(letter);
        ...
        if (text.length() == word.length()) {
            if ((text.charAt(0) == word.charAt(0)) &&
                    (text.charAt(1) == word.charAt(1)) &&
                    (text.charAt(2) == word.charAt(2)) &&
                    (text.charAt(3) == word.charAt(3))) {
                text_replace += letter;
            } else {
                text_replace = text;
            }
            ...
            for (int i = 0; i < text.length() - word.length(); i++) {
                if ((text.charAt(i) == word.charAt(0)) &&
                        (text.charAt(i + 1) == word.charAt(1)) &&
                        (text.charAt(i + 2) == word.charAt(2)) &&
                        (text.charAt(i + 3) == word.charAt(3))) {
                    text_replace += letter;
                    i = i + word.length() - 1;
